...
/* ========================================
   STAGE DISPLAY (ESTÁDIO FENOLÓGICO)
   ======================================== */
.stage-display {
    display: none;
...
/* ========================================
   ATTENTION POINTS (PONTOS DE ATENÇÃO)
   ======================================== */
.attention-points {
    display: none;
...
/* CÍRCULOS DAS CATEGORIAS - SEM BORDAS */
.category-circle {
    width: 65px;
    height: 65px;
    border-radius: 50%;
...
/* IMAGENS DENTRO DOS CÍRCULOS - OCUPAM 100% SEM BORDAS */
.category-circle img {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 50%;
    filter: grayscale(1) opacity(0.5); /* Cinza quando não selecionado */
    transition: filter 0.3s, transform 0.3s;
}

/* CATEGORIA SELECIONADA - Apenas destaque sem bordas */
...
.category-item.selected .category-circle.nutrientes {
    box-shadow: 0 4px 16px rgba(142, 142, 147, 0.5),
                0 2px 8px rgba(142, 142, 147, 0.3);
}

.category-item.selected .category-circle.agua {
    box-shadow: 0 4px 16px rgba(48, 176, 199, 0.5),
                0 2px 8px rgba(48, 176, 199, 0.3);
}

/* Imagem colorida quando selecionada */
.category-item.selected .category-circle img {
